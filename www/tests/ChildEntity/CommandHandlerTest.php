 ...
 */
class CommandHandlerTest extends Broadway\CommandHandling\Testing\CommandHandlerScenarioTestCase
{
    private $generator;
    ...
    public function it_can_rename_manufacturer()
    {
        ...
        $this->scenario
            ...
            ->when(
                new RenameManufacturerForPartCommand(
                    $id,
                    'Acme, Inc.'
                )
            )
            ->then([
                new PartManufacturerWasRenamedEvent(
                    $id,
                    'Acme, Inc.'
                )
            ]);
    ...
    public function it_does_not_rename_manufacturer_to_the_same_name()
    {
        ...
        $this->scenario
            ...
            ->when(
                new RenameManufacturerForPartCommand($id, 'Acme, Inc.'))
            ->then([])
        ;
    }
}
